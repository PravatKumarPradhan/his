...
angular
		.module('myApp')
		.controller(
				"worklistForReportReleaseController",
				[
						'$scope',
						'$rootScope',
						'$state',
						...
						function($scope, $rootScope, $state, $cookies,
							...
							$scope.initResultEntryWorklistForValidation = function(orgId,
								...
								try {
									...
									var URI1 = BASE_URL 
									        + ROOT_URL
											+ LIS_BIOCHEMISTRY
											+ WORK_LIST_FOR_REPORT_RELEASE;

									var URI2 = BASE_URL
											+ ROOT_URL
											+ LIS_BIOCHEMISTRY
											+ WORK_LIST_FOR_REPORT_RELEASE_COUNT;
							...
							$scope.generateUrlForReportRelease = function(reportRelease)
							{
							  if(reportRelease!=null)
								  {
									 $scope.labResultMasterDto = reportRelease;
									 ...
									 $scope.labResultMasterDto.listLabSampleResultDetailsMaster = [];
												$state.go('detailsWorklistForReportRelease',
													{
