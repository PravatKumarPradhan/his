(function () {
    ...
    function billableConsumptionController($scope, $rootScope, $http, CONSTANTS, GenericService, $filter, $state, growl, CurrencyService, commonDetailService) {
        var self = this;
        ...
        function initializeController() {
            ...
            self.model.GetBillableConsumption = GetBillableConsumption;
            self.model.NavigateToDetail = NavigateToDetail;

            PopulateDropdown();
            GetBillableConsumption();
        }
        ...
        var GetBillableConsumption = function () {
            ...
            GenericService.serviceAction("POST", URI, data).then(
                function (response) {
                    self.model.billableConsumptionlist = response.data;
                })
            $rootScope.stopLoader();
        }
        ...
        var NavigateToDetail = function (item) {
            ...
            $state.go('detailsbillableConsumption');
    ...
    function config($stateProvider) {
        $stateProvider.state("billableConsumption", {
            url: '/billableConsumption',
            templateUrl: 'views/PharmacyInventory/InPatient/billable-consumption.html',
            controller: "BillableConsumption.Controller",
            controllerAs: "vm"
        });
    }
    ...
    angular
        .module("myApp")
        .config(config)
        .controller("BillableConsumption.Controller", billableConsumptionController)
})();
