(function () {
    ...
    function materialIssueListController($scope, $rootScope, $http, $state, GenericService,CONSTANTS, commonDetailService, $filter, growl) {
        var self = this;
        var selectItemList = [];
        var masterId;
        //Default Constructor
        ...
        var getDropdownsList = function () {
            ...
            var URI = CONSTANTS.INVENTORY.STORE.MATERIAL_ISSUE.MATERIAL_ISSUE_LIST.DROPDOWN_API;
        ...
        var MaterialIssueListData = function () { 
            var URI = CONSTANTS.INVENTORY.STORE.MATERIAL_ISSUE.MATERIAL_ISSUE_LIST.SEARCH_API;
            

            // var URI = constants.apiurl + constants.inventoryApi + '/material/issue/list/search';
            var data = {  
    ...
    function config($stateProvider) {
        $stateProvider.state("materialIssue.issueList", {
            url: '/issueList',
            templateUrl : 'views/PharmacyInventory/InPatient/material-issue-list.html',
            controller: "MaterialIssueList.Controller",
            controllerAs: 'vm'
        });
    }
    ...
    angular
        .module("myApp")
        .config(config)
        .controller("MaterialIssueList.Controller", materialIssueListController)
})(); 