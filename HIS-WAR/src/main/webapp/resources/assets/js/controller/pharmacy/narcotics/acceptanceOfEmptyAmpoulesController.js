(function () {
    ...
    function acceptanceOfEmptyAmpoulesController($scope, $rootScope, $http, CONSTANTS, GenericService, $filter, $state, growl, CurrencyService, commonDetailService) {
        var self = this;
        ...
        function initializeController() {
            ...
            self.model.GetAcceptanceEmptyAmpoules = GetAcceptanceEmptyAmpoules;
            self.model.NavigateToDetail = NavigateToDetail;

            PopulateDropdown();
            GetAcceptanceEmptyAmpoules();
        }
        ...
        var GetAcceptanceEmptyAmpoules = function () {
            var URI =  CONSTANTS.PHARMACY.NARCOTICS.ACCEPTANCE_EMPTY_AMPOULES.SEARCH_API;
            ...
            GenericService.serviceAction("POST", URI, data).then(
                function (response) {
                    self.model.acceptanceOfEmptyAmpoulesList = response.data;
                })
            $rootScope.stopLoader();
        }
        ...
        var NavigateToDetail = function (item) {
            ...
            $state.go('detailsAcceptanceOfEmptyAmpoules');
        }
    ...
    function config($stateProvider) {
        $stateProvider.state("acceptanceOfEmptyAmpoules", {
            url: '/acceptanceOfEmptyAmpoules',
            templateUrl: 'views/PharmacyInventory/NarcoticsStore/acceptance-of-empty-ampoules.html',
            controller: "AcceptanceOfEmptyAmpoules.Controller",
            controllerAs: "vm"
        });
    }
    ...
    angular
        .module("myApp")
        .config(config)
        .controller("AcceptanceOfEmptyAmpoules.Controller", acceptanceOfEmptyAmpoulesController)
})();
