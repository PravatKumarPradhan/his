...
public class BactClassificationMasterDto {
	
	private Integer bactClassificationId;
	private String code;
	private String desc;
	 ...
	 */
	public Integer getBactClassificationId() {
		return bactClassificationId;
	}
	/**
	 * @param bactClassificationId the bactClassificationId to set
	 */
	public void setBactClassificationId(Integer bactClassificationId) {
