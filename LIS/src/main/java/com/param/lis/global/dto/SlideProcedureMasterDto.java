...
public class SlideProcedureMasterDto {
	
	private Integer slideProcedureId;
	private String code;
	private String desc;
	 ...
	 */
	public Integer getSlideProcedureId() {
		return slideProcedureId;
	}
	/**
	 * @param slideProcedureId the slideProcedureId to set
	 */
	public void setSlideProcedureId(Integer slideProcedureId) {
