...
public class AntibioticClassMasterDto {
	private Integer antibioticClassId;
	private String code;
	private String desc;
	 ...
	 */
	public Integer getAntibioticClassId() {
		return antibioticClassId;
	}
	/**
	 * @param antibioticClassId the antibioticClassId to set
	 */
	public void setAntibioticClassId(Integer antibioticClassId) {
